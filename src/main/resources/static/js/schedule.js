		...
		var render = function() {
			...
			for(var i = 0; i < total; i++) {
				if(i < startWeek) {
					...
					eleTemp.push('<li class="current-month" ><span  class="currentDate dayStyle ' + addClass + '">' + (i + 1 - startWeek) + '</span><div class="day_time"><div>点检：' + Morning + '</div><div>点检：' + Afternoon + '</div></li>')
				} else {
